  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName={'QuoteForm'}>
        <Stack.Screen name="QuoteForm" component={QuoteFormScreen} options={{ title: 'Quick Quote' }} />
        <Stack.Screen name="QuoteResult" component={QuoteResultScreen} options={{ title: 'Quick Quote' }} />
      </Stack.Navigator>
    </NavigationContainer>
  )
}
